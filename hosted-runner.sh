...
./config.sh --url https://github.com/bcarranza/money-tracker --token AEWG2K5JXYPBUONMRCP7TO3GKIZ2S --name webserver-$(echo $SERVERNAME) --labels $(echo $SERVERNAME) --unattended
# Last step, run it!
